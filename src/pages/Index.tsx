...
const SERVICES = [
  { icon: "Ruler", title: "Замер и проект", desc: "Выезд специалиста, обмеры проёма, разработка проекта и согласование всех деталей перед производством." },
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-end">
          <div>
            ...
            <p className="text-sm text-zinc-500 leading-relaxed max-w-md">
              Работаем с вашим или нашим материалом. При заказе двух конструкций на одном объекте — скидка на вторую. Работаем круглый год.
            </p>
